        ...
        <>
          <div className="flex flex-row justify-center items-center gap-2 mt-3">
            <input
              ...
              id=""
              placeholder="Search..."
              className="p-2 text-black rounded m-1 w-2/3"
            />
            <button className={`${colors.btnbg}  p-2 rounded text-base`}>
              Search
            </button>
          </div>

          <ul className="">
            <h4 className="text-2xl font-bold text-center mt-3 mb-2 ">
              All Dishes
            </h4>
            <li
              className={`tracking-wider ${colors.hoverBackground} p-2 border-b border-gray-700 cursor-pointer`}
            >
              <Link to="/chef-intelligence/generatedDish">Butter Chicken</Link>
            </li>
            <li
              className={`tracking-wider ${colors.hoverBackground} p-2 border-b border-gray-700 cursor-pointer`}
            >
              <Link to="/chef-intelligence/generatedDish">Paneer Masala</Link>
            </li>
            <li
              className={`tracking-wider ${colors.hoverBackground} p-2 border-b border-gray-700 cursor-pointer`}
            >
              <Link to="/chef-intelligence/generatedDish">Chicken Biryani</Link>
            </li>
