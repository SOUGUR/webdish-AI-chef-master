      ...
      <div>
        <BannerCard
          slides={[
            {
              imageUrl:
                "https://static.toiimg.com/photo/74984407.cms?width=500&resizemode=4&imgsize=1699947",
            },
            {
              imageUrl:
                "https://img.freepik.com/free-photo/photo-table-with-traditional-indian-food-celebrate-diwali_125540-3655.jpg",
            },
            {
              imageUrl:
              ...
              {!viewMore && index < 4 ? (
                ...
                <>
                  {viewMore ? (
                    <div
                      key={index}
                      className="text-center w-[180px] md:w-auto"
                    >
                      <Link to={state.stateName}>
                          ...
                          <img
                            ...
                            className={`${
                              index === 0 || index === 7
                                ? "margin-top-image"
                                : ""
                            } w-[160px] h-[160px] md:w-[200px] md:h-[200px] object-cover border-2 shadow-xl shadow-slate-400`}
                            src={state.stateLogo}
                            alt={state.stateName}
                          />
                          <p className="mt-3 text-center text-lg font-bold">
