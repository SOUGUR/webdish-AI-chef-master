...
function QuickDishes() {
  ...
  const slides = [
    {
      imageUrl:
        "https://www.eatthis.com/wp-content/uploads/sites/4/2019/08/quick-easy-veggie-rice-bowl-recipe.jpg",
    },
    {
      imageUrl:
        "https://insanelygoodrecipes.com/wp-content/uploads/2021/01/Vegetarian-Panini-with-Tomatoes-and-Mozarella.png",
    },
    {
      imageUrl:
  ...
  const DishText =
    "https://see.fontimg.com/api/renderfont4/BWA45/eyJyIjoiZnMiLCJoIjo4MSwidyI6MTI1MCwiZnMiOjY1LCJmZ2MiOiIjMDAwMDAwIiwiYmdjIjoiI0ZGRkZGRiIsInQiOjF9/UXVpY2sgRGlzaGVzIEN1aXNpbmU/rosmatika-regular.png";
  ...
  return (
    <div className="bg-[#f7f3cd] max-w-full overflow-x-hidden">
      <div>
        <BannerCard
          slides={slides}
          subtitle="Quick Culinary Bliss - Delicious Expeditions in Speedy Dishes"
          title={<img src={DishText} className="filter invert" alt="Indian" />}
        />
      </div>
      <div className="py-12">
        <div>
          <div className="pb-6 pt-6 flex justify-between px-4 md:px-8">
            ...
            <div className="flex justify-end mr-8">
              <button onClick={() => window.scrollTo(0, 0)}>
                <Link
                  to="/SuggestedRandomQuickDishes"
                  className=" text-end font-semibold text-lg sm:text-lg md:text-2xl"
                >
