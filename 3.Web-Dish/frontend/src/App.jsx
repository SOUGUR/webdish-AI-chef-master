  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          path="/Luxury-Dishes/Spanish/SpanishLuxuryBreakFast"
          element={<SpanishLuxuryBreakFast />}
        />
        <Route
          path="/Luxury-Dishes/Spanish/SpanishLuxuryLunch"
          element={<SpanishLuxuryLunch />}
        />
        <Route
          path="/Luxury-Dishes/Spanish/SpanishLuxuryDinner"
          element={<SpanishLuxuryDinner />}
        />
        <Route path="/Luxury-Dishes/Indian" element={<Indian />} />
        <Route
          path="/Luxury-Dishes/Indian/IndianLuxuryBreakFast"
          element={<IndianLuxuryBreakFast />}
        />
        <Route
          path="/Luxury-Dishes/Indian/IndianLuxuryLunch"
          element={<IndianLuxuryLunch />}
        />
        <Route
          path="/Luxury-Dishes/Indian/IndianLuxuryDinner"
          element={<IndianLuxuryDinner />}
        />
        ...
        <Route
          path="/RecommendedQuickDishes"
          element={<RecommendedQuickDishes />}
        />
        <Route
          path="/SuggestedRandomQuickDishes"
          element={<SuggestedRandomQuickDishes />}
        />
        ...
        <Route
          path="/All-Indian-Dishes/Andhra Pradesh"
          element={<AndhraPradesh />}
        />
        <Route
          path="/All-Indian-Dishes/Andhra Pradesh/AndhraPradeshLuxuryBreakFast"
          element={<AndhraPradeshLuxuryBreakFast />}
        />
        <Route
          path="/All-Indian-Dishes/Andhra Pradesh/AndhraPradeshLuxuryLunch"
          element={<AndhraPradeshLuxuryLunch />}
        />
        <Route
          path="/All-Indian-Dishes/Andhra Pradesh/AndhraPradeshLuxuryDinner"
          element={<AndhraPradeshLuxuryDinner />}
        />
        <Route
          path="/All-Indian-Dishes/Arunachal Pradesh"
          element={<ArunachalPradesh />}
        />
        <Route
          path="/All-Indian-Dishes/Arunachal Pradesh/ArunachalPradeshLuxuryBreakFast"
          element={<ArunachalPradeshLuxuryBreakFast />}
        />
        <Route
          path="/All-Indian-Dishes/Arunachal Pradesh/ArunachalPradeshLuxuryLunch"
          element={<ArunachalPradeshLuxuryLunch />}
        />
        <Route
          path="/All-Indian-Dishes/Arunachal Pradesh/ArunachalPradeshLuxuryDinner"
          element={<ArunachalPradeshLuxuryDinner />}
        />
      </Routes>
    </BrowserRouter>
  );
