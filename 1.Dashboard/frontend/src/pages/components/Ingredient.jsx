    ...
    return (
        ...
        <span
          ...
          Please add all ingredients separately{" "}
            ...
            <div
                className="bg-transparent rounded-xl p-4 lg:p-8 py-4 lg:py-4 flex flex-col justify-center items-center">
                        ...
                        <>
                            <div className="flex flex-col lg:flex-row gap-0 lg:gap-4 md:ml-[25%]">
                                <div className="w-full lg:w-2/3 pt-4 lg:pt-0">
                                    ...
                                    <input disabled={portion !== 1} type="text" name="ingredient_name"
                                           value={ingredientName} onChange={(e) =>
