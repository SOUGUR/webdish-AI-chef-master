...
const jobData = [
  {
    ...
    jobDescription:
      "We are seeking a skilled Frontend Developer Engineer with a passion for creating seamless and engaging user experiences. The ideal candidate will have a strong foundation in web development technologies and a keen eye for detail. As a Frontend Developer Engineer at AI CHEF MASTER, you will work closely with our design and backend teams to implement responsive and high-performance web applications. Please note that this is a non-stipend developer position.",
    keyResponsibilities: [
