...
const jobData = [
  {
    ...
    jobDescription:
      "We are seeking a motivated Backend Developer Intern with a passion for server-side development and a keen interest in creating high-performance applications. The ideal candidate will work closely with our frontend and infrastructure teams to design, develop, and maintain our backend systems. Please note that this is a non-stipend developer position.",
    keyResponsibilities: [
